...
_, x_pred = localpredictnrmse(x, len_test, m = best_m, tau = best_tau, Tmax = T, nnei = nn, q = 0, show = 'False')
...
corrdimV, logrM, logCrM, polyM = correlationdimension(x, best_tau, 10, show = True)